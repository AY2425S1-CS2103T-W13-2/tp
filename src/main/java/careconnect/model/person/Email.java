...
public class Email {
    ...
    public static final String MESSAGE_CONSTRAINTS = "Emails should be of the format "
            ...
            + "the parentheses, (" + SPECIAL_CHARACTERS + "). The local-part may not start or end"
            + " with any special "
            + "characters.\n"
            ...
            + "    - have each domain label consist of alphanumeric characters, separated only by"
            + " hyphens, if any.";
    // alphanumeric and special characters
    private static final String ALPHANUMERIC_NO_UNDERSCORE = "[^\\W_]+"; // alphanumeric
    // characters except underscore
    private static final String LOCAL_PART_REGEX =
            "^" + ALPHANUMERIC_NO_UNDERSCORE + "([" + SPECIAL_CHARACTERS + "]"
