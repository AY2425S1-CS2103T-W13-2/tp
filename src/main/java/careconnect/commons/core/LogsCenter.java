 ...
 * by default,
 * at the {@code INFO} level. A new {@code .log} file with a new numbering will be created after
 * the log
...
public class LogsCenter {
    ...
    private static Logger baseLogger; // to be used as the parent of all other loggers created by
    // this class.
    ...
    /**
     * Initializes loggers with the log level specified in the {@code config} object. Applies to
     * all loggers created
     * using {@link #getLogger(String)} and {@link #getLogger(Class)} methods except for those
     ...
     * created logger
     * becomes a descendant of the {@code baseLogger}. Furthermore, the returned logger will have
     * the same log handlers
