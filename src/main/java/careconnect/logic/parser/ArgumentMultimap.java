 ...
 * Keys are unique, but the list of argument values may contain duplicate argument values, i.e.
...
public class ArgumentMultimap {
     ...
     * If the map previously contained a mapping for the key, the new value is appended to the
     ...
     * Modifying the returned list will not affect the underlying data structure of the
     * ArgumentMultimap.
     */
